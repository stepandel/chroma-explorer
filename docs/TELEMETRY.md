...
Tracked API key events may include the provider category only, never key values,
environment variable names, account IDs, tokens, or credential-derived details:
